...
document.getElementById("form").onclick= function(){
  ...
  if ((document.getElementById("form1").value!='') && (document.getElementById("form2").value!='') && (document.getElementById("form3").value!='') && (document.getElementById("form4").checked) ){
    document.getElementById("form1").value='';
    document.getElementById("form2").value='';
    document.getElementById("form3").value='';
    document.getElementById("form4").checked='false';
    alert('Сообщение отправленно!')
  }
  else{
    alert('Заполните все необходимые поля перед отправкой');
